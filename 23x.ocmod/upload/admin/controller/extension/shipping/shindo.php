<?php
class ControllerExtensionShippingShindo extends Controller {
	private $error = array();
	public function index() {
		$this->load->language('extension/shipping/shindo');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/shipping/shindo', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/shipping/shindo', 'token=' . $this->session->data['token'], true);

		$data['cancel'] = $this->url->link('extension/extension', 'token=' . $this->session->data['token'] . '&type=shipping', true);


		$data['provinces'] = $this->model_extension_shipping_shindo->getProvinces();
		...
		$this->response->setOutput($this->load->view('extension/shipping/shindo', $data));
	}
	...
	public function cities() {
		...
		$json = $this->model_extension_shipping_shindo->getCities($this->request->get['province_id']);
